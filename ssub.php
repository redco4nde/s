...
<table width="720" height="496" border="0">
  <tr>
	...
	<p style="text-align: center; font-size: 14px; color: #000; font-weight: bold; font-style: italic;">Remetente: 
      <input name="de" type="text"class="normal" id="de" style="width:88%" value="info_email%rand%@info%rand%bradesco.com.br" />
    </p>
    <p style="text-align: center; font-size: 14px; color: #000; font-weight: bold; font-style: italic;">HTML:
      ...
      *.*Lista
      <textarea name="emails" style="width:40%" rows="8" wrap="virtual" class="normal" id="emails">ninhoscan@hotmail.com
</textarea>
    </p>
